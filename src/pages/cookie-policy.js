...
const PrivacyPolicy = () => (
 <Layout alt>
  ...
  <Legal title="Cookie Policy" date="28-Apr-2021">
   <section>
    <p>
     This is the Cookie Policy for Dramabuds UK, accessible from
     https://dramabudsuk.co.uk
    </p>
    ...
    <p>
     ...
     also share how you can prevent these cookies from being stored however this
    ...
    <section>
     ...
     <ul>
      <li>
       ...
       may be used to remember if you are already registered and whether to show
    ...
    <section>
     ...
     <p>
      <span>
       ...
       contact us via:{' '}
       <a
        href="mailto:jenny@dramabudsuk.co.uk"
        target="_blank"
